...
const CLASS_NAME_LAYOUT_FIXED = 'layouts-fixed'
const CLASS_NAME_NAVBAR_FIXED = 'layouts-navbar-fixed'
const CLASS_NAME_NAVBAR_SM_FIXED = 'layouts-sm-navbar-fixed'
const CLASS_NAME_NAVBAR_MD_FIXED = 'layouts-md-navbar-fixed'
const CLASS_NAME_NAVBAR_LG_FIXED = 'layouts-lg-navbar-fixed'
const CLASS_NAME_NAVBAR_XL_FIXED = 'layouts-xl-navbar-fixed'
const CLASS_NAME_FOOTER_FIXED = 'layouts-footer-fixed'
const CLASS_NAME_FOOTER_SM_FIXED = 'layouts-sm-footer-fixed'
const CLASS_NAME_FOOTER_MD_FIXED = 'layouts-md-footer-fixed'
const CLASS_NAME_FOOTER_LG_FIXED = 'layouts-lg-footer-fixed'
const CLASS_NAME_FOOTER_XL_FIXED = 'layouts-xl-footer-fixed'
